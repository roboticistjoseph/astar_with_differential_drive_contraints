    ...
    while (len(priority_list) != 0):
        ...
        for move in moves:
            ...
            if (X1 != None):
                ...
                new_node = Node(x, y, present_node, th, ct, move[0], move[1], present_node.c2c + X1[3], c2g,
                                present_node.c2c + X1[3] + c2g)
                ...
                if new_node_id in unexplored_nodes:
                    ...
                    heapq.heappush(priority_list,
                                   [unexplored_nodes[new_node_id].total_cost, unexplored_nodes[new_node_id]])
